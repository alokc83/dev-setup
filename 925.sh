...
###############################################################################
# 🌱 alokc83/dev-setup - Save time, write code                                #
###############################################################################
...
# Licensed under GNU 2.0 (C) Alok Choudhary 2023 <https://alokchoudhary.com>  #
###############################################################################

# User-specified config
BREWFILE_LOCATION="${HOME}/.Brewfile"
REMOTE_BREWFILE="https://raw.githubusercontent.com/alokc83/dev-setup/main/Brewfile925"
...
download_brewfile () {
  echo -en "\n⬇️  ${HEADING_COLOR}Downloading Brewfile (\n$REMOTE_BREWFILE)${RESET}\n"
...
show_intro () {
  echo -e "\n${QUESTION_COLOR}🌱 alokc83/dev-setup - Save time, write code${RESET}"
...
echo -e "\x1b[2m ____________________________ \n< Thank you for using script >\n ---------------------------- \n        \   ^__^\n         \  (oo)\_______\n            (__)\       )\/\\n                ||----w |\n                ||     ||\n"
echo -e "\033[0;33m\x1b[2m<github.com/alokc83/dev-setup>${RESET}"
